    ...
    <div className="flex flex-col flex-1">
      ...
      <div className="max-w-3xl p-1 overflow-hidden">
        <p className="leading-relaxed text-lg" style={fontstyle}>
          I am currently pursuing a Master’s degree in Computer Science at a university, focusing on machine learning applications.
          I obtained my Bachelor of Engineering degree in
      ...
      >
        <li>
          2024.09 - Present, M.E. in Computer Science.
        </li>
        <li>
